                ...
                //if !color_states[position]
                {
                    match prefix1
                    {
                        ...
                        PREFIX_COLOR_LUMA=>
                        {
                            ...
                            output_vec[position]=decoder.read_next_symbol(&luma_other_diff_lookup)?.wrapping_sub(16).wrapping_add(prev_luma_base_diff.wrapping_add(output_vec[position-backref]));
